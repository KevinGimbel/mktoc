This README.md is taken from [https://github.com/terraform-aws-modules/terraform-aws-vpc/blob/master/README.md](https://github.com/terraform-aws-modules/terraform-aws-vpc/blob/master/README.md) as part of the complex README parsing test.
